<button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation"
    class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer md:hidden hover:bg-green-700 focus:bg-green-700
...
<a href="<?= url('/home') ?>" class="flex items-center justify-between mr-4">
    <img class="absolute ml-4 md:ml-16 h-12 pt-1 sm:pt-10 md:h-28" src="<?= url('public/img/logo-pf.svg') ?>"
        alt="Logo programas de formacion" />
</a>
